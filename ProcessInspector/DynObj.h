...
{
	CDialog::OnSize(nType, cx, cy); // need to change to CDialogEx if the base is CDialogEx
...
void someClass::OnGetMinMaxInfo(MINMAXINFO* lpMMI)
{
	...
	CDialog::OnGetMinMaxInfo(lpMMI); // need to change to CDialogEx if the base is CDialogEx
}
*/
